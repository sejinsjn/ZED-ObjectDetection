...
#include <memory>
#include "../../../../src/zed-ros2-examples/rviz-plugin-zed-od/src/plugin/include/zed_od_display.hpp"
...
QT_INIT_METAOBJECT const QMetaObject rviz_plugin_zed_od::displays::ZedOdDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<rviz_common::MessageFilterDisplay<zed_interfaces::msg::ObjectsStamped>::staticMetaObject>(),
